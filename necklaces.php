...
<head>
    ...
    <title>Shop Necklaces - Sustain Jewelry Co.</title>
    <meta name="description" content="Shop our beautiful, ethically sourced necklaces. Sustain Jewelry provides a large collection of the most affordable, fine mineral, natural jewelry.">
       ...
       <div class="row">
           ...
           <div class="col-md-10"></div>
                <div class="cardComponent">
                    ...
                    $sql = "select * from products WHERE category LIKE 'Necklaces%'";
